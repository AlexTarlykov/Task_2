...
public class FrameForTask {
    ...
    public static void main(String[] args) {
        ...
        panel.add(table());
        panel.add(buttonForCreateFibonacciNumbersList(panel));
        panel.add(textFieldForSizeOfFibonacciNumbersList(panel));
    ...
    static JTextField textFieldForSizeOfFibonacciNumbersList(JPanel panel) {
    ...
    static JButton buttonForCreateFibonacciNumbersList(JPanel panel) {
        JButton button = new JButton("Fibonacci list");
        ...
        button.addActionListener(new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    JTextField textField = (JTextField) panel.getComponentAt(10, 110);
                    ...
                    if (size >= 0) {
                        ...
                        SinglyLinkedList<Integer> list = SinglyLinkedList.fibonacciNumbersList(size);
                        for (int i = 0; i < list.size(); i++) {
                            table.setValueAt(list.getValue(i), 0, i);
                        }
                    } else {
